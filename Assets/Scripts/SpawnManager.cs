...
public class SpawnManager : MonoBehaviour
{
    ...
    void Start()
    {
        for(int i = 0; i < 6; i++){
            ...
            Instantiate(birdPrefab, GenerateSpawn(min, max,7), birdPrefab.transform.rotation);
            min -= 20;
            max -= 20;
        }
    ...
    void Update()
    {
        ...
        if (DinoController.over){
            ...
            if (birdCount < 6){
                ...
                max = brr2.Min();
                Instantiate(birdPrefab, GenerateSpawn(max-40, max-20,7), birdPrefab.transform.rotation);
            }
